...
router.post("/", async(req, res) => {
    ...
    db.query(
        "INSERT INTO products (title, image, images, description, price, quantity, short_desc, cat_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)", [title, image, images, description, price, quantity, short_desc, cat_id],
        (err, results) => {
            if (err) {
                console.log(err);
...
router.put("/:productId", async(req, res) => {
    ...
    db.query(
        "UPDATE products SET title=?, image=?, images=?, description=?, price=?, quantity=?, short_desc=?, cat_id=? WHERE id=?", [title, image, images, description, price, quantity, short_desc, cat_id, productId],
        (err, results) => {
            if (err) {
                console.log(err);
